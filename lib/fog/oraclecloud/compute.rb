    ...
    class OracleCloud < Fog::Service
      ...
      class Real
        ...
        def authenticate
          ...
          if response.nil? || !response.headers['Set-Cookie']
            raise Error, 'Could not authenticate to Compute Cloud Service. Check your athentication details in your config'
          end

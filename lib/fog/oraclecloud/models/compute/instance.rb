    ...
    class OracleCloud
      class Instance < Fog::Model
        ...
        def get_public_ip_address
          if !networking['eth0'] || !networking['eth0']['nat'] || !networking['eth0']['nat'].include?('ipreservation:')
        ...
        def add_public_ip_address
          ...
          if existing
            raise ArgumentError, "Can't add public id address to instance that already has one (#{existing.ip})"
          end
          begin

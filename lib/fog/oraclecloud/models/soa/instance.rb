    ...
    class SOA
      class Instance < Fog::Model
        ...
        def service_name=(value)
          if value.include?('_') || value[0] !~ /[[:alpha:]]/ || (value.size > 50) || value[/[a-zA-Z0-9-]+/] != value
        ...
        def topology=(value)
          if %w[osb soa soaosb b2b mft apim insight].include? value
        ...
        def shape=(value)
          if %w[oc1m oc2m oc3m oc4m oc5m].include? value
        ...
        def admin_password=(value)
          if value[0] !~ /[[:alpha:]]/ || (value.size < 8) || (value.size > 30) || value !~ /[_#$]/ || value !~ /[0-9]/
